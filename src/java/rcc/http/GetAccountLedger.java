 ...
 * account ledger tracks all account changes as determined by the rcc.ledgerAccounts,
 * rcc.ledgerLogUnconfirmed and rcc.ledgerTrimKeep properties.
 * </p>
 * <table>
 ...
 *           The administrator password is required if more than rcc.maxAPIRecords entries are to be searched.
 *       </td>
 *     </tr>
 *     <tr>
 *       <td>event</td>
 ...
 *           The maximum number of entries returned is limited by the rcc.maxAPIRecords property
 ...
 *     <tr>
 *       <td>rcc_BALANCE</td>
 *       <td>Change in the rcc balance for the account.  There is no 'holding'.</td>
 *     </tr>
 *     <tr>
 ...
 *     </tr>
 *     <tr>
 *       <td>UNCONFIRMED_rcc_BALANCE</td>
 *       <td>Change in the unconfirmed rcc balance for the account.  There is no 'holding'.</td>
 *     </tr>
 *   </tbody>
 * </table>
 */
public class GetAccountLedger extends APIServlet.APIRequestHandler {
     ...
     * @return                      API response
     * @throws  rccException        Invalid request
     */
    @Override
