...
import static rcc.http.JSONResponses.*;

/**
 * Start a funding monitor
 * <p>
 * A funding monitor will transfer rcc, ASSET or CURRENCY from the funding account
 ...
 * <p>
 * rcc amounts are specified with 8 decimal places.  Asset and Currency decimal places
...
public final class StartFundingMonitor extends APIServlet.APIRequestHandler {
     ...
     * @throws  rccException        Unable to process request
     */
    @Override
