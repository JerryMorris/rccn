...
public final class Convert {
    ...
    public static String rsAccount(long accountId) {
        return "rcc-" + Crypto.rsEncode(accountId);
    }
    ...
    public static String readString(ByteBuffer buffer, int numBytes, int maxLength) throws rccException.NotValidException {
        if (numBytes > getMaxStringSize(maxLength)) {
            throw new rccException.NotValidException("Max parameter length exceeded");
        }
    ...
    public static long parsercc(String rcc) {
        return parseStringFraction(rcc, 8, Constants.MAX_BALANCE_rcc);
    }
