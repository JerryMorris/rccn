...
import rcc.rccException.rccIOException;
...
public class CountingInputReader extends FilterReader {
     ...
     * @throws  rccIOException      Maximum count exceeded
     */
    private void incCount(long c) throws rccIOException {
        count += c;
        if (count > limit)
            throw new rccIOException("Maximum size exceeded: " + count);
    }
}
