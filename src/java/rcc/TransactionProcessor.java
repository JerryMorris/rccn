...
public interface TransactionProcessor extends Observable<List<? extends Transaction>,TransactionProcessor.Event> {
    ...
    void broadcast(Transaction transaction) throws rccException.ValidationException;

    void processPeerTransactions(JSONObject request) throws rccException.ValidationException;
    ...
    List<Transaction> restorePrunableData(JSONArray transactions) throws rccException.NotValidException;
}
