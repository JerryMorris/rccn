...
public final class Shuffler {
    ...
    private static final int MAX_SHUFFLERS = rcc.getIntProperty("rcc.maxNumberOfShufflers");
    ...
    private static void scheduleExpiration(Shuffling shuffling) {
        int expirationHeight = rcc.getBlockchain().getHeight() + 720;
    ...
    private volatile rccException.NotCurrentlyValidException failureCause;
    ...
    public rccException.NotCurrentlyValidException getFailureCause() {
        return failureCause;
    }
    ...
    private void submitTransaction(Attachment.ShufflingAttachment attachment) {
        ...
        try {
            Transaction.Builder builder = rcc.newTransactionBuilder(Crypto.getPublicKey(secretPhrase), 0, 0,
                    (short) 1440, attachment);
            builder.timestamp(rcc.getBlockchain().getLastBlockTimestamp());
            ...
            if (participantAccount == null || transaction.getFeeNQT() > participantAccount.getUnconfirmedBalanceNQT()) {
                ...
                failureCause = new rccException.NotCurrentlyValidException("Insufficient balance");
    ...
    public static class ShufflerException extends rccException {
