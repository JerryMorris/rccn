...
/**
 * Issue a currency on the rcc blockchain
 * <p>
 * A currency is the basic block of the rcc Monetary System it can be exchanged with rcc, transferred between accounts,
 ...
 * For {@link rcc.CurrencyType#RESERVABLE} currency
 * <li>minReservePerUnitNQT - the minimum rcc value per unit to allow the currency to become active
 * For {@link rcc.CurrencyType#RESERVABLE} currency
 ...
 * For {@link rcc.CurrencyType#MINTABLE} currency
 * <li>maxDifficulty - for mint-able currency, the exponent of the final difficulty.
 * For {@link rcc.CurrencyType#MINTABLE} currency
 * <li>algorithm - the hashing {@link rcc.crypto.HashFunction algorithm} used for minting.
 * For {@link rcc.CurrencyType#MINTABLE} currency
 * </ul>
 * <p>
 * Constraints
 * <ul>
 * <li>A given currency can not be neither {@link rcc.CurrencyType#EXCHANGEABLE} nor {@link rcc.CurrencyType#CLAIMABLE}.<br>
 * <li>A {@link rcc.CurrencyType#RESERVABLE} currency becomes active once the blockchain height reaches the currency issuance height.<br>
 ...
 * When a {@link rcc.CurrencyType#RESERVABLE} becomes active, in case it is {@link rcc.CurrencyType#CLAIMABLE} the rcc used for
 * reserving the currency are locked until they are claimed back.
 * When a {@link rcc.CurrencyType#RESERVABLE} becomes active, in case it is non {@link rcc.CurrencyType#CLAIMABLE} the rcc used for
 * reserving the currency are sent to the issuer account as crowd funding.
 * <li>When issuing a {@link rcc.CurrencyType#MINTABLE} currency, the number of units per {@link rcc.http.CurrencyMint} cannot exceed 0.01% of the
 ...
 * difficulty increases linearly with the number units minted per {@link rcc.http.CurrencyMint}<br>
 * </ul>
 *
 * @see rcc.CurrencyType
 * @see rcc.crypto.HashFunction
 */
