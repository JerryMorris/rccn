...
public final class Constants {
    ...
    public static final boolean isTestnet = rcc.getBooleanProperty("rcc.isTestnet");
    public static final boolean isOffline = rcc.getBooleanProperty("rcc.isOffline");
    public static final boolean isLightClient = rcc.getBooleanProperty("rcc.isLightClient");
    public static final boolean isAutomatedTest = isTestnet && rcc.getBooleanProperty("rcc.isAutomatedTest");
    public static final String customLoginWarning = rcc.getStringProperty("rcc.customLoginWarning", null, false, "UTF-8");

    public static final int MAX_NUMBER_OF_TRANSACTIONS = 255;
    public static final int MIN_TRANSACTION_SIZE = 176;
    public static final int MAX_PAYLOAD_LENGTH = MAX_NUMBER_OF_TRANSACTIONS * MIN_TRANSACTION_SIZE;
    public static final long MAX_BALANCE_rcc = 1000000000;
    public static final long ONE_rcc = 100000000;
    public static final long MAX_BALANCE_NQT = MAX_BALANCE_rcc * ONE_rcc;
    public static final long INITIAL_BASE_TARGET = 153722867;
    public static final long MAX_BASE_TARGET = MAX_BALANCE_rcc * INITIAL_BASE_TARGET;
    ...
    public static final int MAX_ROLLBACK = Math.max(rcc.getIntProperty("rcc.maxRollback"), 720);
    public static final int GUARANTEED_BALANCE_CONFIRMATIONS = isTestnet ? rcc.getIntProperty("rcc.testnetGuaranteedBalanceConfirmations", 1440) : 1440;
    public static final int LEASING_DELAY = isTestnet ? rcc.getIntProperty("rcc.testnetLeasingDelay", 1440) : 1440;
    public static final long MIN_FORGING_BALANCE_NQT = 1000 * ONE_rcc;

    public static final int MAX_TIMEDRIFT = 15; // allow up to 15 s clock difference
    public static final int FORGING_DELAY = rcc.getIntProperty("rcc.forgingDelay");
    public static final int FORGING_SPEEDUP = rcc.getIntProperty("rcc.forgingSpeedup");
    public static final int BATCH_COMMIT_SIZE = rcc.getIntProperty("rcc.batchCommitSize", Integer.MAX_VALUE);
    ...
    static {
        int maxPrunableLifetime = rcc.getIntProperty("rcc.maxPrunableLifetime");
        ENABLE_PRUNING = maxPrunableLifetime >= 0;
        MAX_PRUNABLE_LIFETIME = ENABLE_PRUNING ? Math.max(maxPrunableLifetime, MIN_PRUNABLE_LIFETIME) : Integer.MAX_VALUE;
    }
    public static final boolean INCLUDE_EXPIRED_PRUNABLE = rcc.getBooleanProperty("rcc.includeExpiredPrunable");
    ...
    static final long UNCONFIRMED_POOL_DEPOSIT_NQT = (isTestnet ? 50 : 100) * ONE_rcc;
    public static final long SHUFFLING_DEPOSIT_NQT = (isTestnet ? 7 : 1000) * ONE_rcc;

    public static final boolean correctInvalidFees = rcc.getBooleanProperty("rcc.correctInvalidFees");
    ...
    public static final boolean DISABLE_FULL_TEXT_SEARCH = rcc.getBooleanProperty("rcc.disableFullTextSearch");
    public static final boolean DISABLE_METADATA_DETECTION = rcc.getBooleanProperty("rcc.disableMetadataDetection");
