...
public interface Transaction {
    ...
    interface Builder {
        ...
        Transaction build() throws rccException.NotValidException;

        Transaction build(String secretPhrase) throws rccException.NotValidException;
    ...
    void validate() throws rccException.ValidationException;
