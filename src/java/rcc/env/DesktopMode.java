...
public class DesktopMode implements RuntimeMode {
    ...
    public void launchDesktopApplication() {
        ...
        try {
            desktopApplication = Class.forName("rccdesktop.DesktopApplication");
            desktopApplication.getMethod("launch").invoke(null);
        } catch (ReflectiveOperationException e) {
            Logger.logInfoMessage("rccdesktop.DesktopApplication failed to launch", e);
        }
    }
    ...
    public void shutdown() {
        ...
        try {
            ...
            Logger.logInfoMessage("rccdesktop.DesktopApplication failed to shutdown", e);
        }
    }
