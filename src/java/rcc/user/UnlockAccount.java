...
import static rcc.user.JSONResponses.LOCK_ACCOUNT;
...
public final class UnlockAccount extends UserServlet.UserRequestHandler {
    ...
    JSONStreamAware processRequest(HttpServletRequest req, User user) throws IOException {
        ...
        if (account == null) {
            ...
            try (DbIterator<? extends Transaction> transactions = rcc.getTransactionProcessor().getAllUnconfirmedTransactions()) {
            ...
            int blockchainHeight = rcc.getBlockchain().getLastBlock().getHeight();
            try (DbIterator<? extends Block> blockIterator = rcc.getBlockchain().getBlocks(accountId, 0)) {
            ...
            try (DbIterator<? extends Transaction> transactionIterator = rcc.getBlockchain().getTransactions(accountId, (byte) -1, (byte) -1, 0, false)) {
