...
import rcc.http.EventListener.PendingEvent;
 ...
 * rcc.apiEventTimeout will be used if no timeout value is specified or
 * if the requested timeout is greater than rcc.apiEventTimeout.</li>
 * </ul>
 *
