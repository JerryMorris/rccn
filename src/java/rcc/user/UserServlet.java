...
import static rcc.user.JSONResponses.DENY_ACCESS;
import static rcc.user.JSONResponses.INCORRECT_REQUEST;
import static rcc.user.JSONResponses.POST_REQUIRED;

public final class UserServlet extends HttpServlet  {

    abstract static class UserRequestHandler {
        abstract JSONStreamAware processRequest(HttpServletRequest request, User user) throws rccException, IOException;
        boolean requirePost() {
            return false;
        }
    }

    private static final boolean enforcePost = rcc.getBooleanProperty("rcc.uiServerEnforcePOST");
    ...
    private void process(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        } catch (RuntimeException|rccException e) {
