...
public final class AddOns {
    ...
    static {
        ...
        rcc.getStringListProperty("rcc.addOns").forEach(addOn -> {
        ...
        if (!addOns.isEmpty() && !rcc.getBooleanProperty("rcc.disableSecurityPolicy")) {
            System.setProperty("java.security.policy", rcc.isDesktopApplicationEnabled() ? "rccdesktop.policy" : "rcc.policy");
