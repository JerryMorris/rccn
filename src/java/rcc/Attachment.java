...
import static rcc.util.bbh.LengthRwPrimitiveType.BYTE;
import static rcc.util.bbh.LengthRwPrimitiveType.SHORT;
import static rcc.util.bbh.LengthRwPrimitiveType.UBYTE;
...
public interface Attachment extends Appendix {
    ...
    abstract class AbstractAttachment extends Appendix.AbstractAppendix implements Attachment {
        ...
        @Override
        final void validate(Transaction transaction) throws rccException.ValidationException {
        ...
        final int getFinishValidationHeight(Transaction transaction) {
            return isPhased(transaction) ? transaction.getPhasing().getFinishHeight() - 1 : rcc.getBlockchain().getHeight();
        }
    ...
    final class MessagingAliasAssignment extends AbstractAttachment {
        ...
        MessagingAliasAssignment(ByteBuffer buffer, byte transactionVersion) throws rccException.NotValidException {
            super(buffer, transactionVersion);
    ...
    final class MessagingAliasSell extends AbstractAttachment {
        ...
        MessagingAliasSell(ByteBuffer buffer, byte transactionVersion) throws rccException.NotValidException {
            super(buffer, transactionVersion);
    ...
    final class MessagingAliasBuy extends AbstractAttachment {
        ...
        MessagingAliasBuy(ByteBuffer buffer, byte transactionVersion) throws rccException.NotValidException {
            super(buffer, transactionVersion);
            this.aliasName = MessagingAliasAssignment.ALIAS_NAME_RW.readFromBuffer(buffer);
        }
    ...
    final class MessagingAliasDelete extends AbstractAttachment {
        ...
        MessagingAliasDelete(final ByteBuffer buffer, final byte transactionVersion) throws rccException.NotValidException {
            super(buffer, transactionVersion);
            this.aliasName = MessagingAliasAssignment.ALIAS_NAME_RW.readFromBuffer(buffer);
        }
    ...
    final class MessagingPollCreation extends AbstractAttachment {
        ...
        MessagingPollCreation(ByteBuffer buffer, byte transactionVersion) throws rccException.NotValidException {
            super(buffer, transactionVersion);
            ...
            if (numberOfOptions > Constants.MAX_POLL_OPTION_COUNT) {
                throw new rccException.NotValidException("Invalid number of poll options: " + numberOfOptions);
            }
    ...
    final class MessagingVoteCasting extends AbstractAttachment {
        ...
        public MessagingVoteCasting(ByteBuffer buffer, byte transactionVersion) throws rccException.NotValidException {
            super(buffer, transactionVersion);
            pollId = buffer.getLong();
            int numberOfOptions = buffer.get();
            if (numberOfOptions > Constants.MAX_POLL_OPTION_COUNT) {
                throw new rccException.NotValidException("More than " + Constants.MAX_POLL_OPTION_COUNT + " options in a vote");
            }
    ...
    final class MessagingPhasingVoteCasting extends AbstractAttachment {
        ...
        MessagingPhasingVoteCasting(ByteBuffer buffer, byte transactionVersion) throws rccException.NotValidException {
            super(buffer, transactionVersion);
            ...
            if (secretLength > Constants.MAX_PHASING_REVEALED_SECRET_LENGTH) {
                throw new rccException.NotValidException("Invalid revealed secret length " + secretLength);
            }
            if (secretLength > 0) {
    ...
    final class MessagingHubAnnouncement extends AbstractAttachment {
        ...
        MessagingHubAnnouncement(ByteBuffer buffer, byte transactionVersion) throws rccException.NotValidException {
            super(buffer, transactionVersion);
            this.minFeePerByteNQT = buffer.getLong();
            int numberOfUris = buffer.get();
            if (numberOfUris > Constants.MAX_HUB_ANNOUNCEMENT_URIS) {
                throw new rccException.NotValidException("Invalid number of URIs: " + numberOfUris);
            }
        ...
        MessagingHubAnnouncement(JSONObject attachmentData) throws rccException.NotValidException {
            super(attachmentData);
            ...
            try {
                ...
                throw new rccException.NotValidException("Error parsing hub terminal announcement parameters", e);
            }
        }
    ...
    final class MessagingAccountInfo extends AbstractAttachment {
        ...
        MessagingAccountInfo(ByteBuffer buffer, byte transactionVersion) throws rccException.NotValidException {
            super(buffer, transactionVersion);
    ...
    final class MessagingAccountProperty extends AbstractAttachment {
        ...
        MessagingAccountProperty(ByteBuffer buffer, byte transactionVersion) throws rccException.NotValidException {
            super(buffer, transactionVersion);
    ...
    final class ColoredCoinsAssetIssuance extends AbstractAttachment {
        ...
        ColoredCoinsAssetIssuance(ByteBuffer buffer, byte transactionVersion) throws rccException.NotValidException {
            super(buffer, transactionVersion);
            this.name = NAME_RW.readFromBuffer(buffer);
            this.description = DESCRIPTION_RW.readFromBuffer(buffer);
    ...
    final class ColoredCoinsAssetTransfer extends AbstractAttachment {
        ...
        ColoredCoinsAssetTransfer(ByteBuffer buffer, byte transactionVersion) throws rccException.NotValidException {
            super(buffer, transactionVersion);
    ...
    final class ColoredCoinsAssetProperty extends AbstractAttachment {
        ...
        public ColoredCoinsAssetProperty(ByteBuffer buffer, byte transactionVersion) throws rccException.NotValidException {
            super(buffer, transactionVersion);
            this.assetId = buffer.getLong();
            this.property = PROPERTY_NAME_RW.readFromBuffer(buffer).trim();
            this.value = PROPERTY_VALUE_RW.readFromBuffer(buffer).trim();
    ...
    final class ColoredCoinsDividendPayment extends AbstractAttachment {
        ...
        ColoredCoinsDividendPayment(ByteBuffer buffer, byte transactionVersion) {
            ...
            if (getVersion() == 2) {
                ...
                this.holdingId = 0;
                this.holdingType = HoldingType.rcc;
            }
            this.assetId = buffer.getLong();
        ...
        boolean verifyVersion(byte transactionVersion) {
            return transactionVersion == 0 ? getVersion() == 0 : getVersion() == 1 || (getVersion() == 2 && rcc.getBlockchain().getHeight() >= Constants.ASSET_INCREASE_BLOCK);
        }
    ...
    final class DigitalGoodsListing extends AbstractAttachment {
        ...
        DigitalGoodsListing(ByteBuffer buffer, byte transactionVersion) throws rccException.NotValidException {
            super(buffer, transactionVersion);
    ...
    class DigitalGoodsDelivery extends AbstractAttachment {
        ...
        DigitalGoodsDelivery(ByteBuffer buffer, byte transactionVersion) throws rccException.NotValidException {
            super(buffer, transactionVersion);
    ...
    final class UnencryptedDigitalGoodsDelivery extends DigitalGoodsDelivery implements Encryptable {
        ...
        void putMyBytes(ByteBuffer buffer) {
            if (getGoods() == null) {
                throw new rccException.NotYetEncryptedException("Goods not yet encrypted");
            }
    ...
    final class MonetarySystemCurrencyIssuance extends AbstractAttachment {
        ...
        MonetarySystemCurrencyIssuance(ByteBuffer buffer, byte transactionVersion) throws rccException.NotValidException {
            super(buffer, transactionVersion);
            this.name = NAME_RW.readFromBuffer(buffer);
    ...
    final class ShufflingRecipients extends AbstractShufflingAttachment {
        ...
        ShufflingRecipients(ByteBuffer buffer, byte transactionVersion) throws rccException.NotValidException {
            super(buffer, transactionVersion);
            int count = buffer.get();
            if (count > Constants.MAX_NUMBER_OF_SHUFFLING_PARTICIPANTS || count < 0) {
                throw new rccException.NotValidException("Invalid data count " + count);
            }
    ...
    final class ShufflingCancellation extends AbstractShufflingAttachment {
        ...
        ShufflingCancellation(ByteBuffer buffer, byte transactionVersion) throws rccException.NotValidException {
            super(buffer, transactionVersion);
            int count = buffer.get();
            if (count > Constants.MAX_NUMBER_OF_SHUFFLING_PARTICIPANTS || count <= 0) {
                throw new rccException.NotValidException("Invalid data count " + count);
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (size > Constants.MAX_PAYLOAD_LENGTH) {
                    throw new rccException.NotValidException("Invalid data size " + size);
                }
            ...
            count = buffer.get();
            if (count > Constants.MAX_NUMBER_OF_SHUFFLING_PARTICIPANTS || count <= 0) {
                throw new rccException.NotValidException("Invalid keySeeds count " + count);
            }
    ...
    final class TaggedDataUpload extends TaggedDataAttachment {
        ...
        public TaggedDataUpload(String name, String description, String tags, String type, String channel, boolean isText,
                                String filename, byte[] data) throws rccException.NotValidException {
            ...
            if (isText && !Arrays.equals(data, Convert.toBytes(Convert.toString(data)))) {
                throw new rccException.NotValidException("Data is not UTF-8 text");
            }
        }
