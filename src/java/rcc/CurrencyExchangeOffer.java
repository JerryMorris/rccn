...
public abstract class CurrencyExchangeOffer {
    ...
    static void exchangeCurrencyForrcc(Transaction transaction, Account account, final long currencyId, final long rateNQT, final long units) {
    ...
    static void exchangerccForCurrency(Transaction transaction, Account account, final long currencyId, final long rateNQT, final long units) {
    ...
    CurrencyExchangeOffer(long id, long currencyId, long accountId, long rateNQT, long limit, long supply,
        ...
        this.creationHeight = rcc.getBlockchain().getHeight();
